...
#  if defined UV_VIS2
     ...
     DO i=MAX(IstrR,Lm(ng)+1-Iwrk),IendR  ! East
       ...
       END DO
     END DO
     DO i=IstrR,MIN(2*Iwrk,IendR)  ! West
       cff1=visc2(ng)+cff*REAL(2*Iwrk-i,r8)
       DO j=JstrR,JendR
         visc2_r(i,j)=MAX(visc2_r(i,j),cff1)
         visc2_p(i,j)=MAX(visc2_p(i,j),cff1)
       END DO
...
#   if defined ISOTOPE
       cff4=tnu2(i16O,ng)+cff1*REAL(Iwrk-j,r8)
...
#   endif
       END DO
     END DO
     DO i=IstrR,MIN(Iwrk,IendR)   ! West
#   if defined ISOTOPE
       cff2=tnu2(i16O,ng)+cff1*REAL(Iwrk-i,r8)
       cff3=tnu2(i18O,ng)+cff1*REAL(Iwrk-i,r8)
#   endif
       cff4=tnu2(itemp,ng)+cff1*REAL(Iwrk-i,r8)
       cff5=tnu2(isalt,ng)+cff1*REAL(Iwrk-i,r8)
       DO j=JstrR,JendR
         diff2(i,j,itemp)=MAX(diff2(i,j,itemp),cff2)
         diff2(i,j,isalt)=MAX(diff2(i,j,isalt),cff3)
#   if defined ISOTOPE
