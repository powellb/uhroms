...
!
      ...
      spherical=.TRUE.
      DO j=Jmin,Jmax
        val1=1.0_r8+dy*(REAL(j,r8)-0.5_r8)/100000.0_r8
        val2=1.0_r8+dy*REAL(j,r8)/100000.0_r8
        DO i=Imin,Imax
          lonr(i,j)=160.0_r8 + dx*(REAL(i,r8)-0.5_r8)/100000.0_r8
          latr(i,j)=val1
          lonu(i,j)=160.0_r8 + dx*REAL(i,r8)/100000.0_r8
          lonp(i,j)=lonu(i,j)
          latu(i,j)=latr(i,j)
          lonv(i,j)=lonr(i,j)
          latv(i,j)=val2
